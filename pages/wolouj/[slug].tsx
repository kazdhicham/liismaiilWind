        ...
        <div className='h-screen'>
            ...
            <div className="grid grid-cols-12 gap-3 relative bg-primary">
                <div>
                    ...
                    <FaCity size={70} color='cyan' data-aos="fade-in"
                ...
                <div>
                    <FaEbay size={70} color={'violet'} data-aos='fade-out' className={`w-full bg-white text-center mt-5  border-solid rounded-tr-xl rounded-bl-xl border-2 hover:border-dotted 
                ...
                <div>
                    ...
                    <FaGit size={70} color={'red'} data-aos='slide-up' className={`w-full  bg-slate-50 text-center mt-5 border-solid rounded-tr-xl rounded-bl-xl
